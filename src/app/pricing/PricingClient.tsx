              ...
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    tier.highlight
                      ? 'bg-primary text-white hover:bg-[#7A3E1E]'
                      : tier.monthlyPrice === 0
                      ? 'border-2 border-[rgba(30,20,10,0.08)] text-[#6B6058] hover:border-primary hover:text-[#7A3E1E]'
                      : 'border-2 border-primary text-[#7A3E1E] hover:bg-primary hover:text-white'
                  )}
                >
                  {tier.cta}
                </button>
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-14">
            {SAJA_GUIDES.map((guide) => (
              <div key={guide.id} className="card border border-[rgba(30,20,10,0.08)]/80">
                <div className="inline-block bg-[#FDF5E8] text-[#7A3E1E] text-xs px-2.5 py-1 rounded-full mb-3 font-medium">
                  Saja Guide
                </div>
