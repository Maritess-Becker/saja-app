  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-heading text-5xl text-[#232323] mb-8">Allgemeine Geschäftsbedingungen</h1>
        <div className="text-[#232323] space-y-4">
          ...
          <h2 className="font-heading text-2xl text-[#232323]">§ 1 Geltungsbereich</h2>
          <p>Diese AGB gelten für alle Nutzer der Plattform Saja.</p>
          <h2 className="font-heading text-2xl text-[#232323]">§ 2 Leistungen</h2>
