  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-heading text-5xl text-dark mb-8">Datenschutzerklärung</h1>
        <div className="prose prose-sm text-text/70 space-y-4">
          ...
          <h2 className="font-heading text-2xl text-dark">Verantwortliche Stelle</h2>
          <p>[Name und Adresse folgen]</p>
          <h2 className="font-heading text-2xl text-dark">Erhobene Daten</h2>
          <p>E-Mail-Adresse, Profildaten (Name, Alter, Fotos, Bio etc.), Nutzungsverhalten auf der Plattform.</p>
          <h2 className="font-heading text-2xl text-dark">Deine Rechte</h2>
          <p>
