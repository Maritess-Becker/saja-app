  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <h1 className="font-heading text-5xl text-[#232323] mb-8">Datenschutzerklärung</h1>
        <div className="prose prose-sm text-[#232323] space-y-4">
          ...
          <h2 className="font-heading text-2xl text-[#232323]">Verantwortliche Stelle</h2>
          <p>[Name und Adresse folgen]</p>
          <h2 className="font-heading text-2xl text-[#232323]">Erhobene Daten</h2>
          <p>E-Mail-Adresse, Profildaten (Name, Alter, Fotos, Bio etc.), Nutzungsverhalten auf der Plattform.</p>
          <h2 className="font-heading text-2xl text-[#232323]">Deine Rechte</h2>
          <p>
